  ...
  return (
    <>
      <div className="w-full font-sans dark:bg-black overflow-x-hidden">
        <section className="min-h-full flex flex-col md:flex-row items-center justify-between gap-10 px-6 sm:px-12 md:px-20 py-16 md:py-0">
          <div className="flex flex-col gap-6 sm:gap-7 max-w-xl w-full text-center md:text-left items-center md:items-start">
            ...
            <div className=" flex flex-wrap items-center justify-center md:justify-start gap-3 sm:gap-4">
              <Button className="group bg-gradient transition-all duration-300 transition-all cursor-pointer duration-300 text-base sm:text-lg text-white font-bold flex items-center gap-2 rounded-full px-5 sm:px-6 h-11 sm:h-12">
                Explore Event
                <MoveRight
                  size={20}
                  strokeWidth={3}
              ...
              <Button className="transition-all cursor-pointer duration-300 hover:bg-gray-100 text-base sm:text-lg bg-transparent text-foreground border border-foreground font-bold flex items-center gap-2 rounded-full px-5 sm:px-6 h-11 sm:h-12">
                Tentang OSIS
              </Button>
            </div>
          </div>
        ...
        <div className="w-full flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-8 font-sans dark:bg-black px-6 sm:px-12 md:px-20 lg:py-10 mt-10 lg:min-h-screen">
